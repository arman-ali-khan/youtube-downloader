...
const index = () => {
  ...
  return (
    <Layout title={downloadData.videoDetails?.title}>
            ...
            <div className="w-96">
              <div className="bg-base-200 px-4 py-2">
                <h2 className="text-xl font-bold">
                  {downloadData.videoDetails?.title}
                </h2>
              </div>
              <div>
                <iframe
                  src={`https://www.youtube.com/embed/${downloadData.videoDetails?.videoId}`}
                  width="100%"
                  height="200px"
                ></iframe>
              </div>
                ...
                {formats?.map((format, i) => (
                  <div
                    className={`flex justify-center ${
                      format.qualityLabel || "hidden"
                    } ${format.hasAudio || "hidden"}`}
                    key={i}
                  >
